            ...
            <div className="container-fluid">
                ...
                <div className="d-flex flex-column gap-4">
                    ...
                    <div className="d-flex flex-column">
                        ...
                        <small><a href="csg0037@alu.medac.es">csg0037@alu.medac.es</a></small>
                        ...
                        <small><a href="https://www.linkedin.com/in/carlos-s%C3%A1nchez-garc%C3%ADa/" target="_blank" className="text-white text-decoration-none">Linkedin Carlos Sánchez</a></small>
                        </div>
                    </div>
                    ...
                    <div className="d-flex flex-column">
                        ...
                        className="img-fluid"
                        />
                        <small><a href="https://www.linkedin.com/in/carlos-s%C3%A1nchez-garc%C3%ADa/" target="_blank" className="text-white text-decoration-none">Linkedin Jorge Valverde</a></small>
                        </div>
                    </div>
                    ...
                    <div className="d-flex flex-column">
                        ...
                        className="img-fluid"
                        />
                        <small><a href="https://www.linkedin.com/in/carlos-s%C3%A1nchez-garc%C3%ADa/" target="_blank" className="text-white text-decoration-none">LInkedin Ángel Sebastián</a></small>
                        </div>
                    </div>
                </div>
                </div>
                ...
                <div className="col-12 col-md-4  mb-5 mb-md-0">
                    <h6>Navegación</h6>
                     <div className="d-flex flex-column justify-content-between gap-4 mt-5">
                        ...
                        <Link href="/Registro" className="nav-link log">Log-in</Link>     
                     </div>
                </div>
            </div>
