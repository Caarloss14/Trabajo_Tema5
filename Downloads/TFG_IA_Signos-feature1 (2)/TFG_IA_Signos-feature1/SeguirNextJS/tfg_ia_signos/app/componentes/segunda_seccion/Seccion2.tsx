...
const seccion2 = () =>{
    ...
    <div className="row justify-content-center align-items-center mt-5">
        ...
        <p className="ms-3">Capturamos todos los movimientos de la mano en tiempo real,Escribimos tus letras de forma dinámica y hacemos que tu comunicación sea mas fluida.</p>
        </div>
